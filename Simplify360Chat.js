...
const Simplify360Chat = (function () {
  ...
  const onChatOpen = () => {
    ...
    if (chatFrame) {
      ...
      if (mq.matches) {
        chatFrame.style =
          "position: fixed;width: 100%;height:100%!important;bottom: 0;right:0;overflow: hidden;z-index: 99999; -webkit-transition: all 0.3s;-moz-transition: all 0.3s;-ms-transition: all 0.3s;-o-transition: all 0.3s;transition: all 0.3s;";
      } else {
