...
let chatPosition = localStorage.getItem("chatPosition") || "left";
...
const Simplify360Chat = (function () {
  ...
  const fullScreenChatWindow = () => {
    ...
    if (chatFrame) {
      chatFrame.style =
        "position: fixed;width: 100% !important;height:100% !important;top: 0;right:0;overflow: hidden;z-index: 999999999;left:0;";
    }
  };
  ...
  const changeChatPosition = () => {
    ...
    if (chatFrame) {
      chatFrame.style = `position: fixed;${chatStatus === "closed" ? ' top: calc(100vh - 6rem)' : `bottom:1rem;`};${chatPosition}:0;overflow: hidden;z-index: 99999;HEIGHT:${chatStatus === "closed" ? "5rem" : "100%"
      ...
      if (deviceViewedOn === "mobile" && chatStatus === "closed") {
        chatFrame.style.top = "1rem";
        chatFrame.style.left = "1rem";
        chatFrame.style.right = "auto";
        chatFrame.style.bottom = "auto";
        chatFrame.style.width = "auto";
  ...
  const onChatOpen = () => {
    ...
    if (chatFrame) {
      ...
      if (mq.matches) {
        chatFrame.style =
          "position: fixed;width: 100%;height:100%!important;top: 0;left:0;overflow: hidden;z-index: 99999; -webkit-transition: all 0.3s;-moz-transition: all 0.3s;-ms-transition: all 0.3s;-o-transition: all 0.3s;transition: all 0.3s;";
      } else {
  ...
  const onChatClose = () => {
    ...
    let chatFrame = window.document.getElementById("s360-chat-iframe");
    if (chatFrame) {
      chatFrame.style = `position: fixed;top:calc(100vh - 6rem);${chatPosition}:0; overflow: hidden;z-index: 99999;height:${chatStatus === "closed" ? "5rem" : "100%"
